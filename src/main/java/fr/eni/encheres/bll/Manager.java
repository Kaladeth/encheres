...
// - - - - - - - - - - METHODES UTILISATEUR - - - - - - - - - - 
	...
	public void ajouterUtilisateur(String pseudo, String nom, String prenom, String email, String telephone, String rue,
		...
		if(pseudo.matches("[A-Za-z0-9]+") != true) { 
			Exception e = new Exception("L'identifiant doit contenir seulement des caractËres alphanumÈriques !");
			bllExceptions.addException(e);
		}
		if(nom == null) {
		...
		if(mdp != confirmationMdp) {
			Exception e = new Exception("Le mot de passe doit Ítre identique au champ confirmation !");
			bllExceptions.addException(e);
		}
